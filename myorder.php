...
<div class="container order-details">
    <div class="col-xs-12">
        ...
        <div class="row">
          <div class="panel panel-default">
            <div class="panel-heading">
              <a href="/newUI/order_detail.php" class="btn btn-info my-order-btn"><strong> OD21344576785356 </strong></a>
              <a href="/newUI/order_detail.php" class="btn btn-default my-order-btn pull-right"><i class="fa fa-map-marker" aria-hidden="true"></i><strong> Track </strong></a>
            </div>
        ...
        <div class="row">
          <div class="panel panel-default">
            <div class="panel-heading">
              <a href="/newUI/order_detail.php" class="btn btn-info my-order-btn"><strong> OD21344576712395 </strong></a>
              <a href="/newUI/order_detail.php" class="btn btn-default my-order-btn pull-right"><i class="fa fa-map-marker" aria-hidden="true"></i><strong> Track </strong></a>
            </div>
            <div class="panel-body">
              <div class="row ordered-item">
                ...
                <div class="col-md-3">
                  <p class="price">DELIVERY DATE</p>
                  <p class="text-muted"><strong>06 April 2017.</strong></p>
                </div>
              </div>
              <hr>
              <div class="row ordered-item">
              ...
              <div class="row my-order-total">
                <span class="price text-muted">Order On :</span>
                <span class="price"> 01 April 2017</span>
              <p class="pull-right"><span class="price text-muted">Order Total </span> <span class="price">Rs. 2943</span></p>
              </div>
            </div>
          </div>
