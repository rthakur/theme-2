    ...
    <form  role="form" action="/newUI/delivery.php">
      <div class="row">
          ...
          <div class="form-group">
              <label for="country" class="control-label">Address Type:</label>
          ...
          <div class="form-group">
              ...
              <input type="text" id="laststName" placeholder="Last Name" class="form-control" required>
          </div>
          <div class="form-group">
              <label for="firstName" class="control-label">Street :</label>
              <input type="text" id="street " placeholder="Street" class="form-control" required>
          </div>
          <div class="form-group">
              <label for="firstName" class="control-label">Additional :</label>
              <input type="text" id="additional " placeholder="Additional " class="form-control" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              <label for="firstName" class="control-label">Postal code :</label>
          ...
          <div class="form-group">
              ...
              <select id="country" class="form-control">
                  ...
                  <option value="AF">Afvalueghanistan</option>
          ...
          <div class="form-group">
              <label for="country" class="control-label">Language :</label>
          ...
          <div class="form-group">
              ...
              <input type="email" id="email" placeholder="name@example.com" class="form-control" required>
          </div>
          </div>
          <div class="col-sm-6">
              ...
              <div id="new-address" style="display:none;">
                  ...
                  <div class="form-group">
                      <label for="firstName" class="control-label">Last Name :</label>
                      <input type="text" id="laststName" placeholder="Last Name" class="form-control">
                  </div>
                  <div class="form-group">
                      <label for="firstName" class="control-label">Street :</label>
                  ...
                  <div class="form-group">
                      <label for="firstName" class="control-label">Additional :</label>
                      <input type="text" id="additional " placeholder="Additional " class="form-control">
                  </div>
                  <div class="form-group">
                      <label for="firstName" class="control-label">City :</label>
      ...
      <div class="row form-group text-center">
          <a href="/newUI/mycart.php" class="btn btn-info address-btn" style="margin-right: 15px;">Previous</a><button class="btn btn-success address-btn">Continue</button>
      </div>
    </form> <!-- /form -->
  </section>
</div> <!-- ./container -->
