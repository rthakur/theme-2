                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/register">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" class="form-control" name="name" value="" required="" autofocus="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" class="form-control" name="password_confirmation" required="" type="password">
                            </div>
                        </div>
